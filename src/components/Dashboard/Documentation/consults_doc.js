export const consultsAll = [
  {
    ...
    value: '<b>Description</b>: Total consults is the sum of consults from the selected date range that have a PCT stop code associated with them.  Consults to the PCT and within team consults should display if set-up correctly.<br/><br/>' +
      '<b>PCT Stop Codes that should be associated with PCT consults:</b><br/><br/>' +
      '<u>562 PTSD - Individual or</u><br/>' +
  ...
  {
    title: 'Pending',
    value: '<b>Description</b>: This status designates requests that have been sent, but not yet acted on by the receiving service.' +
  ...
  {
    title: 'Active',
    value: "<b>Description</b>: This status occurs when a consult is 'received' and efforts are underway to fulfill a consult. A consult may also revert to 'active' in other scenarios such as when an appointment is canceled or no-showed." +
      '(Pending, Active and others) are pulled from the Consult Toolbox application.' +
...
export const consultsUniquesAndStatuses = [
  {
    ...
    value: "<b>Description</b>: Consult Over Time is a line (actually a spline) graph of monthly consults received for the period of time specified on this site's date range drop box selected at the top of this page. " +
  ...
  },
  {
    ...
    value: '<b>Description</b>: The Consult Status pie chart displays the status of all consults pulled for the selected date range for this selected site. ' +
...
export const consultDetails = [
  {
    ...
    value: '<b>Description</b>: Displays information on each individual consult from the selected date range that have a PCT stop code associated with them.  Consults to the PCT and within team consults should display if set-up correctly.  If consults that are not specific to the PCT are displayed, this is an error that needs correcting at the local facility. <br/><br/>' +
