export const ebps = [
  {
    ...
    value:
      ...
      'Numerator: The EBPs Session numerator reflects a count of PCT encounters documented using national and approved local templates with health factors. <br/>' +
...
export const PTSD = [
  {
    ...
    value:
      'PTSD Only Session Counts<br/><br/>' +
      '<u>Numerator</u>: The PTSD Session numerator reflects a count of PCT encounters documented using only PTSD templates. Not included are EBP sessions for CBT-D, CBT-I or IPT-D.' +
      'Only encounters of the following encounter types are used in counting EBP PTSD sessions:<br/><br/>' +
      'INDIVIDUAL SESSIONS: CPT Procedure Codes 90832 OR 90834 OR 90837<br/>' +
      'CRISIS SESSIONS: CPT Procedure Codes 90839<br/>' +
      'GROUP SESSIONS: CPT Procedure Codes 90853<br/>' +
      'FAMILY SESSIONS: CPT Procedure Codes 90847 OR 90849',
  ...
  },
  {
    ...
    value:
      'PTSD Only Session Counts<br/><br/>' +
      '<u>Denominator</u>: The PTSD Only Session denominator reflects a count of total PCT encounters whether documented as EBP sessions or not.  ' +
  ...
  },
  {
    ...
    value:
      'PTSD Only Patient Counts<br/><br/>' +
      '<u>Numerator</u>: The PTSD Only Patients numerator reflects a count of unique PCT patients with encounters only PTSD templates. Not included are EBP sessions for CBT-D, CBT-I or IPT-D. <br/>' +
