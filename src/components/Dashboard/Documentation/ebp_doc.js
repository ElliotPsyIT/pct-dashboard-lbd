...
export const IndividualAndGroupTxEBPs = [
  ...
  },
  {
    ...
    value:
      'Group Tx EBP Patient Counts<br/><br/>' +
...
export const ebpActivitySummary = [
  {
    ...
    value:
      'This is a list of the total number of patients administered EBPs by EBP type at the selected medical center site. <br/><br/>' +
      '[This does not include encounters from the <i>Other</i> category on the national PTSD Psychotherapy and MBC template]',
    category: 'EBP Activity Summary Defined ...'
  },
  {
    title: 'EBP Types Pie Chart (right)',
    value:
      'The EBP Types Pie Chart displays the relative proportions, with counts, of the EBP types administered at the selected medical site within the selected timeframe. <br/><br/>' +
      '[This does not include encounters from the <i>Other</i> category on the national PTSD Psychotherapy and MBC template]',
    category: 'EBP Activity Summary Defined ...'
  }
]
...
export const ProvidersEBPsAndSurveysByClinicAndPatient = [
  {
    title: 'Providers EBPs and Surveys By Clinic and Patient',
    value:
      'The Providers EBPs and Surveys By Clinic and Patient Table displays patient level EBP sessions, along with any administered PCL-5 associated with the EBP session. Data is shown for each patient by provider at each institution of the selected medical center site within the timeframe specified. <br/><br/>' +
      '<b>Note</b>: From a data perspective, surveys are connected to the clinic, not the encounter.  The encounter is connected to a clinic.  The dashboard uses a programming rule to connect the survey to the encounter/session.  PCL-5 measures associated with each session are included in the table if they are administered within 24 hours of the EBP session. <br/><br/>' +
      '<b>EBP Sessions</b>: Each providers EBP sessions are shown, including the patient initials, last 4, EBP type, session number when available, and session date and time.<br/><br/>' +
      '<b>Surveys Administered</b>: PCL-5 measures administered within 24 hours prior to the EBP session are listed next to the EBP session information above. Survey name, score, and date of administration are listed. <br/><br/>',
