...
const formatCodes = (codes) => `(${codes.map(code => `'${code}'`).join(', ')})`

// Data structure for the CPT codes
const cptSections = {
  specialNote: {
    title: 'Special Note',
    content: 'Many encounters have more than one procedure codes (CPT codes for clinical service). We have updated this page to count an encounter only once. In order to organize encounters in only one category, we have a step-wise processing for coding. The order is listed below. We first review all encounters with a group code and put into that category, then all remaining encounters with any E&M codes and put into that category, and then all remaining encounters for assesment codes, and so on.'
  },
  // ... rest of your sections
  groupTherapy: {
    title: 'Group Therapy',
    content: 'group therapy code listing',
    codes: [90853]
  },
  emServicces: {
    title: 'E&M Services',
    content: 'Any encounter with E&M codes.  There are a large number of E&M codes, please refer to the Procedure Code Details table at the bottom of this page to see details regarding E&M codes.'
  },
  assessment: {
    title: 'Assessment',
    codes: [90971, 90972]
  ...
  individualTherapy: {
    ...
    codes: [90832, 90834, 90837, 90846, 90847, 90849]
  },
  peerSupport: {
    title: 'Peer Support',
    codes: ['H0038']
  ...
  telephone: {
    title: 'Telephone',
    codes: [98966, 98967, 98968, 99441, 99442, 99443]
  },
  other: {
    title: 'Other',
    content: 'All other codes and pairings not listed above.'
  }
}
...
const buildHTML = (sections) => {
  return Object.entries(sections).map(([key, section]) => {
    if (section.codes) {
      return formatSection(section.title, formatCodes(section.codes))
    } else {
      return formatSection(section.title, section.content)
    }
  }).join('')
}

// Create the object
export const programEncounters = [
  {
    title: 'CPT Procedure Codes Definition',
    value: buildHTML(cptSections),
    category: 'Program Encounters Summary Defined...'
  }
]

export const encountersAndPatients = [
  {
    title: 'Total Encounters and Patient Uniques Definitions',
...
/* export const individualPsychotherapy = [
  {
    ...
    category: 'Individual Psychotherapy Encounters Defined ...'

  }
]
*/
export const groupPsychotherapy = [
  {
    ...
    value: '<u><b>Numerator</b></u>: Total Encounters from all PCT Clinics with the following Group Tx Procedural codes:<br/><br/>' +
      ...
      '<u><b>Denominator</b></u>: Total Encounters from all PCT Clinics regardless of type of service provided.<br/><br/>',
    category: 'Group Psychotherapy Encounters Defined ...'
  }
]
...
export const encounterTelehealthInd = [
  {
    ...
    value: '<u><b>Face To Face</b></u> counts represent the sum total of individual therapy encounters that DO NOT have a Telehealth Secondary Stop Code.  ' +
      ...
      '&nbsp;&nbsp;&nbsp; <u><b>Individual Therapy</b></u>: ' +
      "('90832', '90834', '90837', '90846', '90847', '90849')<br/><br/>" +
  ...
  },
  {
    ...
    value: '<u><b>Individual Therapy By Phone</b></u> counts represent the sum total of individual therapy encounters that have been used in a Phone Clinic (primary stop code 542).  ' +
      '<br/><br/>' +
      '<u>*** Phone Therapy is being displayed since there has been an expansion of authorized therapy codes that can be used in phone care during the COVID-19 epidemic. ' +
      'However, this practice should be increasingly reduced with other telehealth options.</u>' +
      '<br/><br/>' +
      'The sessions are from all PCT Clinics with the following subset of Individual Tx CPT codes:<br/><br/>' +
      '&nbsp;&nbsp;&nbsp;' +
      '<u><b>Individual Therapy</b></u>:' +
...
const TelehealthHome = {
  telehealthHome: {
    title: 'Telehealth to Home',
    content: 'counts represent the sum total of all encounters in PCT that have a Telehealth Secondary Stop Code corresponding to video to home.'
  },
  telehealthSecondary: {
    title: 'The Telehealth Secondary Stop Code to Home is 179',
    content: 'If this Telehealth to Home code is used along with any primary stop code and any procedure code then the encounter counts toward the sum.'
  }
}
const TelehealthAssociate = {
  telehealthAssociate: {
    title: 'Telehealth to Associate Facility',
    content: 'counts represent the sum total of all encounters in PCT that have a Telehealth Secondary Stop Code corresponding to video to home.'
  },
  telehealthSecondary: {
    title: 'The Telehealth Secondary Stop Code to an Associate Facility is 692',
    content: 'If this Telehealth to Associate Facility secondary stop code is used along with any primary stop code and with any procedure code then it signifies a telehealth encounter to an Associate Facility and the encounter counts toward the sum.'
  }
}
const TelehealthParent = {
  telehealthParent: {
    title: 'Telehealth to Different Parent Station',
    content: 'counts represent the sum total of all encounters in PCT that have a Telehealth Secondary Stop Code corresponding to video to home.'
  },
  telehealthSecondary: {
    title: 'The Telehealth Secondary Stop Code to a Different Parent Station is 693',
    content: 'If this Different Parent Station secondary stop code is used along with any primary stop code and with any procedure code then it signifies a telehealth encounter to a Different Parent Station and the encounter counts toward the sum.'
  }
}
const PhoneTherapy = {
  phoneTherapyAll: {
    title: 'Phone Therapy All',
    content: 'counts represent the sum total of all encounters in PCT that have been used in a phone clinic.'
  },
  phoneTherapy: {
    title: 'SPECIAL NOTE',
    content: 'Phone Therapy continues being displayed since there was an expansion of authorized therapy codes that can be used in phone care during the COVID-19 epidemic.  However, this practice should be increasingly reduced with other telehealth options.'
  }
}

const TherapyBySessionType = {
  IndividualOnly: {
    title: 'Individual Tx Only',
    content: 'counts represent the sum total of all encounters in PCT with individual psychotherapy codes (90832, 90834, 90837, 90846, 90847, 90849)'
  },
  GroupOnly: {
    title: 'Group Tx Only',
    content: 'counts represent the sum total of all encounters in PCT with group psychotherapy codes (90853)'
  },
  BothInd: {
    title: 'Both Individual and Group Tx',
    content: 'counts represent the sum total of all patients in PCT with both individual (90832, 90834, 90837, 90846, 90847, 90849) and group psychotherapy codes (90853)'
  }
}
...
export const encounterTelehealthAll = [
  {
    ...
    value: buildHTML(TelehealthHome),
    category: 'Telehealth All Encounters Defined ...'
  },
  {
    title: 'Telehealth to Associate Facility - All',
    value: buildHTML(TelehealthAssociate),
    category: 'Telehealth All Encounters Defined ...'
  },
  {
    title: 'Telehealth to Different Parent Station - All',
    value: buildHTML(TelehealthParent),
    category: 'Telehealth All Encounters Defined ...'
  },
  {
    title: 'Phone Therapy - All',
    value: buildHTML(PhoneTherapy),
    category: 'Telehealth All Encounters Defined ...'
  },
  {
    title: 'Telehealth All - Denominator Counts',
    value: '<u><b>Denominators</b></u>: Total encounters from all PCT Clinics regardless of type of service provided. <br/><br/>',
    category: 'Telehealth All Encounters Defined ...'
  }
]

export const therapyBySessionType = [
  {
    title: 'Psychotherapy Patients by Session Types',
    value: buildHTML(TherapyBySessionType),
    category: 'Psychotherapy Patients by Session Types...'
  }
]
...
const cptDetails = {
  description: {
    title: 'Description',
    content: 'Encounter Counts from all PCT Clinics by type of service provided.'
  },
  procedureCode: {
    title: 'Procedure Code',
    content: 'Displays summary of all coding and coding pairs/multiple coding utilized on encounters within the PCT.'
  },
  procedureCodeName: {
    title: 'Procedure Code Name',
    content: 'Official code names by stop code utilized'
  },
  cptGroup: {
    title: 'CPT Group',
    content: 'This designates the assigned grouping from the Program Encounters Summary (above).'
  },
  note: {
    title: '**Note',
    content: 'Some of the codes in the Other CPT group may represent inappropriate coding practices and should be reviewed.  This could include use of a code that needs to be bundled with another, or use of two psychotherapy codes together.'
  },
  encounter: {
    title: 'Encounters',
    content: 'Total encounters for each procedure code and coding pairs/multiple coding.'
  }
}
// Create the object
