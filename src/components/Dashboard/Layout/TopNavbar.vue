  ...
  export default {
    ...
    methods: {
      ...
      datePickerInput(val, from) {
        ...
        // if (from == 'shortcut' ) {
        //   console.log('datePickerInput shortcut from: ', from)
        ...
        //   // ** code here if there is a novel shortcut
        //   // send start and end dates to refresh the page here
         
        //   // shortcut selected, signal dateRange button back to default style
        //   this.toggleDateRange = false
        //   return
        // } else 

        // datePicker clicked with start and end date
        if (val && val.start != null && val.end != null) {
          ...
          // with completed calendar range, call action w/ start and end date
          // take action
        ...
        // calendar start and end dates trigger action to refresh page
        else {
