...
import { ebps, 
        ...
        ebpActivitySummary,
        ProvidersEBPsAndSurveysByClinicAndPatient} from '../Documentation/ebp_doc.js'
...
export default {
  ...
  data () {
    return {
      ...
      ProvidersEBPsAndSurveysByClinicAndPatient: ProvidersEBPsAndSurveysByClinicAndPatient,
